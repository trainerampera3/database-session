...
-- TRUNCATE TABLE 
-- 	business_location.batch_log,business_location.state_policies,business_location.office_market,business_location.startup_funding,business_location.companies;
Truncate table business_location.companies;

select * from business_location.companies;

select * from business_location.startup_funding;

select * from business_location.office_market;
	
select * from business_location.state_policies;